...
var openHCI_html = "" +
    "<div class='popup' id='openHCI_popup'>" +
        ...
        '<div class="popup_content popup_content_center">' +
            "<div class='popup_title2'>INTRODUCTION</div>" +
            "<div class='popup_content1'>" +
                "Take Me Home </br>是我在人機互動工作坊中參與的專案，</br>" +
                "工作坊結合工程與設計兩方面的人員，</br>" +
                "透過設計思考流程，</br>" +
                "在為期一星期的工作坊中</br>合作完成人機互動專案。</br>" +
            "</div>" +
            "<div class='popup_content1'>" +
                "Take Me Home " + 
                "</br>是一個喚起人們對物品重視的計畫。</br>" +
                "賣場中常會有被錯置的物品，</br>" +
                "但人們往往會忽視此現象的存在，</br>" +
                "我們透過商品擬人化的呼喊動作，</br>" +
                "喚起人們對此現象的重視。" +
        ...
        '<div class="popup_content popup_content_center">' +
            ...
            "<div class='popup_content1'>" +
                "實際前往 IKEA 觀察尋找潛在問題，</br>" +
                "我們發現商場中</br>常會有物品被錯置的現象，</br>" +
                "我們對此現象深感興趣，</br>" +
                "因此以此為出發點</br>作為我們專案的核心。</br>" +
            "</div>" +
        ...
        '<div class="popup_content popup_content_center">' +
            "<div class='popup_title2'>USER OBSERVATIONS</div>" +
            "<div class='popup_title3'>1.店員</div>" +
            "<div class='popup_content1'>" +
                "訪問 IKEA 店員若發現商品被錯置，</br>" +
                "會採取什麼應對措施。</br>" +
                "店員表示並不會對此現象特別進行處理，</br>" +
                "即使看到被錯置的物品" +
                "也只會保持原狀，" +
                "僅會在最後收店時做一次全盤檢查，" +
                "其中最重要的「每泡15分鐘後是否會休息」的問題，" +
